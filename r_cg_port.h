...
#define _00_ADPC_DI_OFF         (0x00U) /* use P20 - P22 as analog input */
#define _03_ADPC_DI_ON          (0x03U) /* use P22 as digital input */
#define _02_ADPC_DI_ON          (0x02U) /* use P21 - P22 as digital input */
#define _01_ADPC_DI_ON          (0x01U) /* use P20 - P22 as digital input */
...
#define _FE_PM3_DEFAULT         (0xFEU) /* PM3 default value */
