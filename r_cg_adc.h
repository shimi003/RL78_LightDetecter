...
#define _00_AD_ADPC_3ANALOG             (0x00U) /* ANI0 - ANI2 */
#define _03_AD_ADPC_2ANALOG             (0x03U) /* ANI0 - ANI1 */
#define _02_AD_ADPC_1ANALOG             (0x02U) /* ANI0 */
#define _01_AD_ADPC_0ANALOG             (0x01U) /* ANI0 - ANI2 (all digital) */
...
typedef enum
{
    ADCHANNEL0, ADCHANNEL1, ADCHANNEL2, ADCHANNEL16 = 16U, ADCHANNEL17,
    ADCHANNEL18, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} ad_channel_t;
typedef enum
{
    ADNORMALINPUT,
